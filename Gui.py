...
before_label = tk.Label(
    content_frame, text="Before", bg="#CBDCEB",  font=("calibri", 20, "bold") ,

)
before_label.grid(row=0, column=0, pady=5)
after_label = tk.Label(
    content_frame, text="After", bg="#CBDCEB",     font=("calibri", 20, "bold"),

)
after_label.grid(row=0, column=1, pady=5)
histogram_label = tk.Label(
    content_frame, text="Histogram", bg="#CBDCEB",     font=("calibri", 20, "bold"),
